    ...
    <div className="space-y-5">
      <section className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--apg-text-secondary)]">Theo dõi QR payOS, webhook và manual review.</p>
        </div>
      ...
      <section className="apg-admin-toolbar px-4 py-4">
        <form className="grid gap-3 xl:grid-cols-[minmax(280px,1fr)_180px_110px_auto_auto] xl:items-end">
      ...
      <section className="apg-admin-sheet overflow-hidden">
        <div className="border-b border-[var(--apg-border-default)] px-4 py-3">
          <h2 className="text-sm font-semibold">QR payOS gần đây</h2>
        </div>

  ...
  return (
    <div className="relative flex items-center gap-1.5">
      ...
      <Link
        ...
        className="relative rounded-md p-2 text-[var(--apg-text-muted)] transition hover:bg-[var(--apg-bg-surface-soft)] hover:text-[var(--apg-text-primary)]"
      ...
      {open ? (
        <div className="absolute right-0 top-10 z-50 w-72 overflow-hidden rounded-lg border border-[var(--apg-border-default)] bg-[var(--apg-bg-surface)] shadow-2xl">
          <div className="border-b border-[var(--apg-border-default)] px-4 py-3">
            ...
            <div className="mt-0.5 truncate text-xs text-[var(--apg-text-muted)]">{user.email}</div>
          ...
          <div className="p-1">
            <Link
              className="flex items-center gap-2 rounded-md px-3 py-2 text-sm text-[var(--apg-text-secondary)] hover:bg-[var(--apg-bg-surface-soft)] hover:text-[var(--apg-text-primary)]"
              href="/"
          ...
          <form action={logoutAction} className="border-t border-[var(--apg-border-default)] p-1">
            <button className="flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-sm text-rose-300 hover:bg-rose-500/10" type="submit">
